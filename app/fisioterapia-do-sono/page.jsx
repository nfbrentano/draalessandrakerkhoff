...
export default function Page() {
  return (
    <>
      <Script id="body-class-app-fisioterapia-do-sono-page-jsx" strategy="beforeInteractive">{`document.body.className = "wp-singular page-template-default page page-id-384 wp-custom-logo wp-embed-responsive wp-theme-site-export-1 jps-theme-site-export-1";`}</Script>
