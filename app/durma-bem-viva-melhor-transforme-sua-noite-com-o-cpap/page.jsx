    ...
    <>
      <script
        dangerouslySetInnerHTML={{
          __html: `document.body.className = "wp-singular post-template-default single single-post postid-161 single-format-standard wp-custom-logo wp-embed-responsive wp-theme-site-export-1 jps-theme-site-export-1";`
        }}
      />
...
<div class="wp-block-group has-global-padding is-layout-constrained wp-container-core-group-is-layout-3437eebd wp-block-group-is-layout-constrained"><h2 class="has-text-align-center wp-block-post-title has-large-font-size">Durma Bem, Viva Melhor: Transforme Sua Noite com o CPAP</h2>
...
_stq = window._stq || [];
_stq.push([ "view", {"v":"ext","blog":"247584566","post":"161","tz":"-3","srv":"draalessandrakerkhoff.com.br","j":"1:15.6"} ]);
_stq.push([ "clickTrackerInit", "247584566", "161" ]);
